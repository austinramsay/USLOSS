...
2. Systems used to develop Phase 2 are: The OS's being used are Windows 10 and Ubuntu 19.10, the Ubuntu OS was the one the was the most in use when executing Phase 2. 
   The GCC version being used by the Windows 10 OS is GCC 4.4.7, the GCC version used by the Unbuntu 19.10 OS is GCC 9.2.1-9ubuntu2.
...
3. /* --------------------------
	...
	Raymond Howard
	-------------------------- */
	|Tests with Failures: Potentially Test 40, however it seems as though our functions worked as described in the specification?|
	...
	Evaluation: PASSED?
				Message contains garbage text possibly due to a 
				pointer error or encoding error. Our result is -1 
				instead of 0 in the testResults. Would it not be -1 
				as the result since any errors with input should 
				return a -1?
	-----------------------------------------------------------------
	starting test 41 ....
